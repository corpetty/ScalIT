...
!   include 'ja3.hgm'    !...8
    ...
    include 'mja3.hgm'    ! use MPI_IO directly, slower, works
!   include 'mja30.hgm'   ! use NIO subroutines, middle, less errors
!   include 'mja31.hgm'   ! use MPI_File_Set_View, fastest, more errors
