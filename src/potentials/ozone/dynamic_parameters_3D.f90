...
real*8 :: epss,acc,rmax(3),rmin(3),poten,hartokcl,ugrad,Max_E,Max_E_seed,E_range,dist_tol(3),E_limit,alpha(3),&
Glob_min,current_geom(3),current_geom_grad(3),mass(3)
